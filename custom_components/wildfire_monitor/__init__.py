"""The Wildfire Monitor integration."""
...
async def async_setup_entry(hass: HomeAssistant, entry: WildfireConfigEntry) -> bool:
    ...
    coordinator = WildfireDataUpdateCoordinator(hass, entry)
...
async def _async_update_listener(hass: HomeAssistant, entry: WildfireConfigEntry) -> None:
    """Reload the entry when options change (radius / alert / interval)."""
